alter table "public"."group_members" add column "event_id" uuid;

alter table "public"."group_members" add constraint "group_members_event_id_fkey" FOREIGN KEY (event_id) REFERENCES public.events(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;

alter table "public"."group_members" validate constraint "group_members_event_id_fkey";
